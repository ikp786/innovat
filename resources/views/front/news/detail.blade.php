                ...
                <div class="col-md-12 col-lg-8 page_content">
                    <div class="blog-posts single-post">
                        ...
                        <div class="text-black">
                            <div class="social_share" onclick="facebook_share({{ route('news', $news->slug) }})">
                                <img src="{{ asset('front/upload/icons/facebook.svg') }}" width="15" height="15"
                                    alt="share in facebook">
                            </div>
                            <div class="social_share" onclick="twitter_share({{ route('news', $news->slug) }})">
                                <img src="{{ asset('front/upload/icons/twitter.svg') }}" width="15" height="15"
                                    alt="share in twitter">
                            </div>
                            <div class="social_share" onclick="linkedin_share({{ route('news', $news->slug) }})">
                            ...
                            <a class="social_share" href="whatsapp://send?text={{ route('news', $news->slug) }}"
                                data-action="share/whatsapp/share">
                                <img src="{{ asset('front/upload/icons/whatsapp-filled.svg') }}" width="15"
                                    height="15" alt="share in whatsapp">
                            </a>
                        </div>
                        ...
                        <img src="{{ asset('uploads/news_images/' . $news->image) }}" alt="{{ $news->title }}">
                        <div class="mt-20">
                            {!! $news->description !!}
                        </div>
                    </div>
                            ...
                            @forelse($newsList as $key => $value)
                                <article class="post media-post clearfix pb-0 mb-25"
                                    ...
                                    <div class="post-right">
                                        <h5 class="post-title mt-0 mb-0"><a class="font-15"
                                                style="font-family: Poppins,sans-serif;"
                                                href="{{ route('news', $value->slug) }}">{{ $value->title }}</a>
                                        </h5>
                                    </div>
                                </article>
                            @empty
