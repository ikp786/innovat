...
<div class="main-content">
                            ...
                            <ul class="splide__list">
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        ...
                                        <a href="tel:+971 52 940 2047" class="text-black">+971 52 940 2047</a>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        <h3 class="font-18 mt-10 mb-10"><a style="color: #006EBB; font-weight: bold;"
                                                href="locations/bms-auditing-abu-dhabi-uae.html">Abu Dhabi</a>
                                        </h3>
                                        <a href="tel:+971 52 997 4124" class="text-black">+971 52 997 4124</a>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        <h3 class="font-18 mt-10 mb-10"><a style="color: #006EBB; font-weight: bold;"
                                                href="locations/bms-auditing-saudi-arabia.html">Saudi
                                                Arabia</a>
                                        </h3>
                                        <a href="tel:+966 54 524 3455" class="text-black">+966 54 524 3455</a>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        <h3 class="font-18 mt-10 mb-10"><a style="color: #006EBB; font-weight: bold;"
                                                href="locations/bms-auditing-qatar.html">Qatar</a>
                                        </h3>
                                        <a href="tel:+974 5991 4414" class="text-black">+974 5991 4414</a>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        <h3 class="font-18 mt-10 mb-10"><a style="color: #006EBB; font-weight: bold;"
                                                href="locations/bms-auditing-bahrain.html">Bahrain</a>
                                        </h3>
                                        <a href="tel:+973 3567 9861" class="text-black">+973 3567 9861</a>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        <h3 class="font-18 mt-10 mb-10"><a style="color: #006EBB; font-weight: bold;"
                                                href="locations/bms-auditing-oman.html">Oman</a>
                                        </h3>
                                        <a href="tel:+968 9656 9829" class="text-black">+968 9656 9829</a>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        <h3 class="font-18 mt-10 mb-10"><a style="color: #006EBB; font-weight: bold;"
                                                href="locations/bms-auditing-india.html">India</a>
                                        </h3>
                                        <a href="tel:+91 892 120 3277" class="text-black">+91 892 120 3277</a>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        <h3 class="font-18 mt-10 mb-10"><a style="color: #006EBB; font-weight: bold;"
                                                href="locations/bms-auditing-uk.html">UK</a>
                                        </h3>
                                        <a href="tel:+44 7436 883294" class="text-black">+44 7436 883294</a>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="item getintouch">
                                        <h3 class="font-18 mt-10 mb-10"><a style="color: #006EBB; font-weight: bold;"
                                                href="locations/bms-auditing-usa.html">USA</a>
                                        </h3>
                                        <a href="tel:+1 929 461 3948" class="text-black">+1 929 461 3948</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <p class="text-black font-15 pb-10 text-justify">Innovate Accounts is the best
                            <b>Accounting and
                                Audit Firm in <a class="text-black"
                                    href="locations/bms-auditing-dubai-uae.html">Dubai</a>, <a class="text-black"
                                    href="locations/bms-auditing-saudi-arabia.html">Mumbai</a>,
                                <!--		<a-->
                                <!--		class="text-black"-->
                                <!--		href="locations/bms-auditing-qatar.html">Qatar</a>, <a-->
                                <!--		class="text-black" href="locations/bms-auditing-bahrain.html">Bahrain</a>,-->
                                <!--<a class="text-black"-->
                                <!--   href="locations/bms-auditing-oman.html">Oman</a>, <a-->
                                <!--		class="text-black"-->
                                <!--		href="locations/bms-auditing-india.html">India</a>, <a-->
                                <!--		class="text-black" href="locations/bms-auditing-uk.html">UK</a>-->
                                <!--and <a class="text-black"-->
                                <!--	   href="locations/bms-auditing-usa.html">USA</a>-->
                            </b>.
    ...
    <div class="brochure_download" style="background-color: #006EBB; padding: 30px 0;">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    {{-- "https://www.bmsauditing.com/upload/files/home/tag_bms.webp?v=1 --}}
