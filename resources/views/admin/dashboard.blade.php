                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="card card-congratulation-medal">
                            <div class="card-body">
                                ...
                                <img src="{{ asset('admin/images/illustration/badge.svg') }}"
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('admin/images/icons/toolbox.svg') }}"
                                                                    alt="Toolbar svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img
                                                                    src="{{ asset('admin/images/icons/parachute.svg') }}">
                                                                alt="Parachute svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('admin/images/icons/brush.svg') }}"
                                                                    alt="Brush svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('admin/images/icons/star.svg') }}"
                                                                    alt="Star svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('admin/images/icons/rocket.svg') }}"
                                                                    alt="Rocket svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('admin/images/icons/speaker.svg') }}"
                                                                    alt="Speaker svg" />
                                                            </div>
                                                        </div>
                                                        <div>
